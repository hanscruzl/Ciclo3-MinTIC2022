...
function limpiar_formulario(){
	//if (confirm("Esta seguro que desea limpiar el formulario?")){
		...
		var campoTextoMensaje = document.getElementById("message");
...
function consultar_todo(){
    $.ajax({
        url:"https://gaa1d59a78302b7-bddistraces.adb.us-sanjose-1.oraclecloudapps.com/ords/admin/message/message",
        type:"GET",
        datatype:"json",
...
function consultaID(){
	...
	if( ide != ""){
		$.ajax({
			...
			url: 'https://gaa1d59a78302b7-bddistraces.adb.us-sanjose-1.oraclecloudapps.com/ords/admin/message/message/' + ide,
